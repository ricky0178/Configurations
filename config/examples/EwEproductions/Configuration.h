...
#define STRING_CONFIG_H_AUTHOR "Ricky" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "UwU Industries"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "ccd284e9-65df-49a7-91b0-c6ab905c83b5"
...
#define DELTA
  ...
  #define DELTA_PRINTABLE_RADIUS 220.0     // (mm)

  // Center-to-center distance of the holes in the diagonal push rods.
  #define DELTA_DIAGONAL_ROD 502.0        // (mm)

  // Distance between bed and nozzle Z home position
  #define DELTA_HEIGHT 645.20             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 267.0              // (mm) Get this value from G33 auto calibrate
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 83.00 }  // default steps per unit for Kossel (GT2, 20 tooth)
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 7000, 7000, 7000, 7000 }
